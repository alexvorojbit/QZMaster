...
//    
//    var quizes: [Quizes] = [] { didSet { collectionView.reloadData() } }
//    
//    // MARK: - UI
...
//        collectionView.register(MultipleQuizCell.self, forCellWithReuseIdentifier: cellID)
//    }
//    
//    override func viewWillAppear(_ animated: Bool) {
//        super.viewWillAppear(animated)
...
//        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellID, for: indexPath) as! MultipleQuizCell
